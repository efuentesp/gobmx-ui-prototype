<table-results>
  <table class="table table-striped bulk_action table-responsive">
       <thead>
         <tr class="headings" >
       ...
       <tr each={rows} class="even pointer">
           ...
           <td >
              <div style="position:relative">
               <button  each={actions}  data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle" type="button" aria-expanded="false"><i class="glyphicon glyphicon-flash"></i> {group} <span class="caret"></span>
               </button>
