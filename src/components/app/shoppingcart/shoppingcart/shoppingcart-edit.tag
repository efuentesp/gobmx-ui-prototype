...
<shoppingcart-edit>
	<page id="shoppingcart-edit" title="Editar Shoppingcart">
		<formbox title="Datos de Shoppingcart" icon="fa fa-check-circle-o" action="update" return="shoppingCart-admin">
			<div class="row">
