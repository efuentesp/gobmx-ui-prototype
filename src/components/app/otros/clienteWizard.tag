<clienteWizard>
	<page title="Cliente Wizard"  id="cliente_wizard">
	  <panel label="Proyección de Pensión">
  		  <form-wizard id="proyeccionPension" title="Pasos para Proyección de Pensión" nextbutton="Siguiente" prevbutton="Anterior" donebutton="Finalizar" return="/cliente-admin/">
